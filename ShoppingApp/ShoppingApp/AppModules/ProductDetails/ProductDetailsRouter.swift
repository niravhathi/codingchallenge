...
class ProductDetailsRouter:ProductDetailsPresenterToRouterProtocol{
    ...
    static func createProductDetailsModule(product: Product?) -> ProductDetailsViewController {
        ...
        let view = ProductDetailsRouter.mainstoryboard.instantiateViewController(withIdentifier: Constant.productDetailsViewController) as! ProductDetailsViewController
