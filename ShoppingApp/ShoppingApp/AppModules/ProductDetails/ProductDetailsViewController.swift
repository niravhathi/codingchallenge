...
extension ProductDetailsViewController: ProductDetailsPresenterToViewProtocol {
    ...
    func responseAddToCartToView() {
        self.showAlertMessage(title: "Success", message: "Product Added to cart Successfully")
    }
}
extension ProductDetailsViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let iCell = collectionView.dequeueReusableCell(withReuseIdentifier: "ProductImagesCollectionViewCell", for: indexPath) as! ProductImagesCollectionViewCell
